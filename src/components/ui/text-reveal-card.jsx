...
export const TextRevealCard = ({ text, revealText, children, className }) => {
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "bg-[#1d1c20] border border-white/[0.08] w-full max-w-2xl rounded-lg p-8 relative overflow-hidden",
        className
      )}
    >
      {children}
      <div className="relative flex items-center overflow-hidden">
        ...
        >
          <p
            ...
            className="text-base sm:text-xl md:text-3xl py-10 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300"
          >
            {revealText}
          </p>
        </motion.div>
        ...
        <div className="overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="text-base sm:text-xl md:text-3xl py-10 font-bold bg-clip-text text-transparent bg-[#323238]">
            {text}
          </p>
          <MemoizedStars />
        </div>
